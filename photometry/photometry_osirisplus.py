...
bands_dict = {
    ...
    'Feige_22': ['02 30 16.62',	'+05 15 50.6', 13.024, 0.050, -0.333, -0.303, -0.273],
    ...
    'Ru-149F': [13.119, 2.469, 0.867, 0.317, 0.166],
    ...
    'G162-66': [13.227, -0.183, -0.387, -0.354, -0.303],
    ...
    'G163-50': [13.266, 0.215, -0.277, -0.272, -0.271],
    ...
    'G15-24': [11.277, 1.035, 0.412, 0.151, 0.052],
    ...
    'G93-48': [12.96, 10.107, -0.308, -0.307, -0.261],
    ...
    'PG2336+004B': [12.312, 1.101, 0.336, 0.100, 0.014]
}
...
def photometry(programa, bloque, filename, conf):
    """Esta función tiene como cometido estimar la magnitud instrumental para la noche de
    observación en función del filtro empleado para ello.

    Args:
        programa (str): El programa científico a observar.
        bloque (str): Número del bloque del programa a observar.
        filename (str): Nombre del archivo que contiene a la estrella de calibración fotométrica.

    Returns:
        float: Estimación de la magnitud instrumental y su error.
    """
    ...
    print(f"Target: {hd['OBJECT']}")
    print(f"Position: {X}, {Y}")
    print(f"Ellipse info -> a: {a}, b: {b} & theta: {theta}")
    print(f"Flux: {flux}")
    ...
    print(f"Kron Radius: {kronrad[0]}")
    print(f"AUTO FLUX: {flux[0]}")
    print(f"AUTO ERROR FLUX: {fluxerr[0]}")
    print(f"AUTO FLAG: {flag[0]}")
